# SOURCE: https://github.com/mpchang/uncovering-missed-tackle-opportunities/blob/main/code/tacklesequence.py
import torch
import typing
import pandas as pd
...
class TackleSequence:
    ...
    def __init__(self, df_sequence: pd.DataFrame, target: typing.Optional[int], tacklerId: int):
        """
